...
class PipelineReportNew(models.Model):
    ...
    def init(self):
        ...
        f.name, h.name, a.create_date::Date, j.opportunity_stages, 
...
class PipelineReportDisplay(models.Model):
    ...
    year=fields.Integer(string="Expected Closing (Year)")
    topline=fields.Integer(string="TopLine")
    bottom_line=fields.Integer(string="BottomLine")
    user_id=fields.Char(string="Sales Person")
    ...
    def init(self):
        ...
        self.env.cr.execute("""CREATE or REPLACE VIEW  %s as(
            ...
            mnth,year,topline,bottom_line,user_id,oppor_name,oppor_stg,sale_stage,cust
